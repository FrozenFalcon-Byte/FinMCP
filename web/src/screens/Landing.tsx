...
const PRIMITIVES: { id: string; n?: string; h: string; method: string; p: string; tone: Tone; viz: ReactNode }[] = [
  { id: "playground", n: "32", h: "Tools", method: "tools/call", tone: "blue", p: "Add, categorise, import, budget, plan goals, track EMIs and run guarded SQL. Written once, used by every client.",
