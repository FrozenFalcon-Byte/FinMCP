...
Claude Code ────┤   (24 tools, 13 resources, 4 prompts)   ├── statement / receipt / SMS parsing
...
finmcp/                 the MCP server and everything it owns
  server.py             24 tools, 13 resources, 4 prompts; per-account TenantState; principal from the request
