...
DEFAULT_CATEGORIES: tuple[CategorySpec, ...] = (
    ...
    CategorySpec("Fees & Charges", "expense", 500, "Bank charges, GST, late fees, ATM charges",
                 ("bank charges", "charges", "gst", "annual fee", "late fee", "convenience fee", "atm", "penalty", "sms charges",
                  "amc")),
    CategorySpec("Loans & EMI", "expense", None, "EMIs and loan repayments: phone, car, home, personal loans",
                 ("loan emi", "emi/", " emi ", "loan", "bajaj finance", "bajaj finserv", "home credit", "tata capital", "hdb financial",
                  "idfc first loan", "no cost emi")),
...
ALIASES: dict[str, str] = {
    ...
    "emi": "Loans & EMI", "emis": "Loans & EMI", "loans": "Loans & EMI", "loan": "Loans & EMI",
